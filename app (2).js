// ============================================
// AUTOMARKET - Главное приложение v2
// ============================================
...
function showDetail(id) {
    ...
    if (seller && seller.telegramId && seller.telegramId !== 'test_user') {
        contactButtons = `
            <button class="contact-btn telegram-btn" onclick="openTelegramChat(${seller.telegramId})">
    ...
    contactButtons += `
        <button class="contact-btn phone-btn" onclick="showPhone('${sellerPhone}', '${sellerName}')">
            <span class="contact-btn-icon">📞</span>
...
function showPhone(phone, sellerName) {
    ...
    // Увеличиваем счетчик показов телефона (для статистики)
