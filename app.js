// ============================================
// AUTOMARKET v4 - ИСПРАВЛЕННАЯ ВЕРСИЯ
// ============================================
...
// РЕНДЕРИНГ - GRID 2 КОЛОНКИ (КАК БЫЛО)
function render() {
...
function handleSubmit(e) {
    ...
    // Переключаемся на главную и обновляем
